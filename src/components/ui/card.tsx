...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-3xl border border-slate-200 bg-white text-slate-950 shadow-sm transition-all duration-200 dark:border-zinc-800/80 dark:bg-zinc-900 dark:text-zinc-50",
      className
    )}
    {...props}
  />
