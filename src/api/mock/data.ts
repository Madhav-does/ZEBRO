...
export const mockSeller: Seller = {
  ...
  riskFactors: [
    ...
    'Zebro Account Linked (@urban_ceramics, > 3 Years Old)',
  ],
  ...
  return {
    ...
    trackingEvents: [
      ...
      },
      {
        ...
        subtitle: 'KYC verified & Zebro authorization active',
        timestamp: 'Sep 24, 2:35 PM',
        hash: '0x12b0e45c7198aa29',
        status: 'completed',
        detail: 'Biometric liveness confirmed against government ID. Linked Zebro handle @urban_ceramics passed age & dispute heuristics.',
      },
      {
        id: 'evt_3',
        stepIndex: 3,
...
export const mockStorefront: Storefront = {
  ...
  storefrontUrl: 'https://zebro.market/@urban_ceramics',
  instagramUrl: 'https://zebro.market/@urban_ceramics',
  rating: 4.98,
  reviewsCount: 46,
